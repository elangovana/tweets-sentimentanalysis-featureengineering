...
def run(traindata_tweet_file, traindata_label_file, devdata_tweet_file,devdata_label_file,output_dir, samplesize=2000 ):
    ...
    df_traindata_label, df_traindata_tweet = GetTweetDataFrame(samplesize, traindata_label_file, traindata_tweet_file)
    df_devdata_label, df_devdata_tweet = GetTweetDataFrame(samplesize, devdata_label_file, devdata_tweet_file)
    ##run 1
...
def GetTweetDataFrame(samplesize, traindata_label_file, traindata_tweet_file):
    ...
    df_traindata_label['sentiment']=df_traindata_label['sentiment'].astype('category')
    if (samplesize > 0):
